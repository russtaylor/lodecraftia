...
import net.minecraft.lodecraftia.block.slabs.PolishedAndesiteSlab;
import net.minecraft.lodecraftia.block.stairs.PolishedAndesiteStairs;
import net.minecraft.lodecraftia.block.slabs.PolishedDioriteSlab;
import net.minecraft.lodecraftia.block.stairs.PolishedDioriteStairs;
import net.minecraft.lodecraftia.block.slabs.PolishedGraniteSlab;
...
import net.minecraft.lodecraftia.block.slabs.SmoothSandstoneSlab;
